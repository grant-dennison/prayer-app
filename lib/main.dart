...
class PrayerItemListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<PrayerContextController>(
      builder: (context, prayerContextController, child) => ListView(
        children: prayerContextController.context.children
            .map((e) => PrayerItemWidget(e))
            .toList(),
      ),
    );
  }
